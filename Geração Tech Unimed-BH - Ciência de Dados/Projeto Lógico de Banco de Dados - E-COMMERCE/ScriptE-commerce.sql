...
-- Pagamentos
INSERT INTO Pagamentos (formaPagamento, dataVencimento, status)
VALUES ('Dinheiro', NULL, 'Pago'),
	   ('Cartão', '2022-11-16', 'Em pagamento'),
	   ('Cartão', NULL, 'Pago'),
	   ('Dinheiro', NULL, 'Pago'),
	   ('PIX', NULL, 'Pago'),
	   ('PIX', NULL, 'Pago'),
	   ('Dinheiro', NULL, 'Não pago'),
	   ('Cartão', NULL, 'Não pago'),
	   ('Cartão', '2022-12-07', 'Em pagamento'),
	   ('Dinheiro', NULL, 'Não pago');
...
-- 4) Visualização da quantidade de produtos estocados em cada estoque e seus respectivos endereços:

SELECT sum(ep.quantidade), e.localizacao 
...
WHERE p.idProduto = ep.produtoId
HAVING ep.quantidade >= 400
